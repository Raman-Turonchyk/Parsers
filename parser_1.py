...
for category_name, category_href in all_categories.items():
    ...
    with open(f'data/{count}_{category_name}.csv', 'w') as file:
        ...
        writer.writerow([products, calories, proteins, fats, carbohydrates])
    ...
    for item in products_data:
        ...
        product_info.append({'Title': title, 'Calories': calories, 'Proteins': proteins, 'Fats': fats, 'Carbohydrates': carbohydrates})

        with open(f'data/{count}_{category_name}.csv', 'a', errors='ignore') as file:
            writer = csv.writer(file, delimiter=';')
